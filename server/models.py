...
class Consultor(Base):
    ...
    pode_criar_programacao = Column(Boolean, nullable=False, server_default=text("true"))
    pode_duplicar_programacao = Column(Boolean, nullable=False, server_default=text("true"))
    pode_excluir_programacao = Column(Boolean, nullable=False, server_default=text("true"))
